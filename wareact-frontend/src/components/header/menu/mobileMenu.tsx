      ...
      {isOpen && (
        <nav className=" relative overflow-x-scroll   w-full  z-50 bg-white px-4 py-6 space-y-6 transition-all duration-300 ease-in-out overflow-y-auto">
          ...
          <div className="mt-36 space-y-[20px] w-full flex flex-col justify-center items-center">
            <button className=" border-[1px] border-[#065AF1] rounded-[100px] text-base leading-[1.4] transition-all duration-300 ease-in-out text-[#065AF1] hover:bg-blue-400 hover:text-white block w-[361px] h-[62px]   ">
              Sign In / Sign Up
            </button>
            <button className=" border-[1px] border-[#065AF1] rounded-[100px] text-base leading-[1.4] transition-all duration-300 ease-in-out text-[#065AF1] hover:bg-blue-400 hover:text-white block w-[361px] h-[62px]   ">
              Book a Demo
